...
import auto.cc.info.dto.carSpecs.SuspensionsDTO;
...
public class SuspensionsController {
    ...
    public SuspensionsDTO addSuspensionsInfo(@RequestBody SuspensionsDTO suspensionsCommand){
        Optional<SuspensionsDTO> suspensionsCommandOptional = Optional.ofNullable(suspensionsService.createNewSuspensionsItems(suspensionsCommand));
