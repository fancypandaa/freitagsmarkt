...
public class SwaggerConfig extends WebMvcConfigurationSupport {
    ...
    @Bean
    void generateSellerGuestToken(){
        UserCommand userCommand = new UserCommand();
        userCommand.setUserName("TIC_TOC");
        userCommand.setPassword("_TOC_TIC");
        userCommand.setRole("SELLER_GUEST");
        String token = jwtGenerator.generate(userCommand);
        System.out.println("TOKEN_SE: "+token+" ROLE : " + userCommand.getRole());
    }
}
